...
export const ACTIVITY_POOL: Activity[] = [
  ...
  },
  {
    id: "qu06",
    type: "question",
    title: "La versión que más querés",
    description: "De vos mismo. De la pareja. De los dos.",
    durationMin: 6,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
    ...
    content: {
      kind: "question",
      question: "¿En qué momento sentiste que eras la mejor versión de vos mismo/a?",
      followUp: "¿Qué estaba pasando en tu vida en ese momento?",
    },
  },
  {
    id: "qu07",
    type: "question",
    title: "Lo que me cambiaste",
    description: "Para bien. Para siempre.",
    durationMin: 6,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja"],
    ...
    content: {
      kind: "question",
      question: "¿Qué cambió en vos desde que estamos juntos/as?",
      followUp: "¿Hay algo que extrañás de antes?",
    },
  },
  {
    id: "qu08",
    type: "question",
    title: "El miedo que nadie sabe",
    description: "Uno de verdad.",
    durationMin: 7,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja"],
    ...
    content: {
      kind: "question",
      question: "¿Qué es lo que más te da miedo perder?",
      followUp: "¿Alguna vez lo dijiste en voz alta antes de ahora?",
    },
  },
  {
    id: "qu09",
    type: "question",
    title: "Escena favorita",
    description: "Un momento nuestro, de película.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
    ...
    content: {
      kind: "question",
      question: "Si tuvieras que elegir una escena de nosotros para guardar para siempre, ¿cuál sería?",
      followUp: "¿Qué tiene esa escena que la hace especial?",
    },
  },
  {
    id: "qu10",
    ...
    description: "Sin filtro. Con nombre y apellido.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
    ...
    content: {
      kind: "question",
      question: "¿Qué es lo que más admirás de mí?",
      followUp: "¿Cuándo lo notaste por primera vez?",
    },
  },
  {
    id: "qu11",
    ...
    description: "La tuya. Sin concesiones.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
      budget: "nada",
      categories: ["conexion", "diversion"],
      intensity: 1,
    },
    content: {
      kind: "question",
      question: "Describí tu noche perfecta. Empezando desde las 6 de la tarde.",
      followUp: "¿Cuántas noches así tuviste en el último año?",
    },
  },
  {
    id: "qu12",
    type: "question",
    title: "Lo que no cierra",
    description: "Una cosa que todavía no entendés del otro.",
    durationMin: 6,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["media"],
    ...
    content: {
      kind: "question",
      question: "¿Hay algo de mí que todavía no terminás de entender?",
      followUp: "¿Querés que te lo explique ahora?",
    },
  },
  {
    id: "qu13",
    type: "question",
    title: "La charla pendiente",
    description: "Esa que postergamos.",
    durationMin: 8,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja"],
    ...
    content: {
      kind: "question",
      question: "¿Hay algo que venías queriendo hablar y no encontraste el momento?",
      followUp: "¿Por qué no encontraste el momento?",
    },
  },
  {
    id: "qu14",
    type: "question",
    title: "Lo que me atrae",
    description: "Más de lo que pensás.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["media", "alta"],
    ...
    content: {
      kind: "question",
      question: "¿Qué es lo que más te atrae físicamente de mí?",
      followUp: "¿Y emocionalmente?",
    },
  },
  {
    id: "qu15",
    ...
    description: "No en años. En semanas.",
    durationMin: 6,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
    ...
    content: {
      kind: "question",
      question: "¿Qué es algo concreto que querés que hagamos juntos en el próximo mes?",
      followUp: "¿Qué necesitaría pasar para que lo hagamos?",
    },
  },
  {
    id: "qu16",
    type: "question",
    title: "El gesto que más valoro",
    description: "Pequeño. Enorme.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja"],
    ...
    content: {
      kind: "question",
      question: "¿Cuál es el gesto más pequeño que el otro tiene y que más te importa?",
      followUp: "¿Se lo dijiste alguna vez?",
    },
  },
  {
    id: "qu17",
    type: "question",
    title: "Si empezara de nuevo",
    description: "La misma persona. Otra historia.",
    durationMin: 6,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["media"],
    ...
    content: {
      kind: "question",
      question: "Si nos conociéramos hoy por primera vez, ¿cómo crees que sería?",
      followUp: "¿Te enamorarías igual?",
    },
  },
  {
    id: "qu18",
    type: "question",
    title: "Lo que más nos hace bien",
    description: "Como pareja. Como equipo.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
    ...
    content: {
      kind: "question",
      question: "¿Qué es lo que más funciona entre nosotros?",
      followUp: "¿Cómo lo cuidamos?",
    },
  },
  {
    id: "qu19",
    ...
    description: "Una sola. La que más importa.",
    durationMin: 4,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["baja", "media"],
    ...
    content: {
      kind: "question",
      question: "¿Con una sola palabra, cómo describirías lo que somos?",
      followUp: "¿Por qué esa y no otra?",
    },
  },
  {
    id: "qu20",
    type: "question",
    title: "El plan que nunca hicimos",
    description: "Ese que siempre queda para después.",
    durationMin: 5,
    tags: {
      locations: ["casa", "afuera"],
      energy: ["media"],
    ...
    content: {
      kind: "question",
      question: "¿Qué es ese plan que hace tiempo queremos hacer y nunca lo concretamos?",
      followUp: "¿Qué haría falta para que pase este mes?",
    },
  },
