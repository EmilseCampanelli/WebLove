...
import { CONTRADICCION_PUZZLES } from "../../../src/data/puzzles/contradiccion/puzzles";
import { ContradictionPuzzle } from "../../../src/data/puzzles/contradiccion/types";
...
function PuzzleCard({ puzzle }: { puzzle: ContradictionPuzzle }) {
  const diff = DIFF_CONFIG[puzzle.difficulty];
  return (
    <Pressable
      style={({ pressed }) => [styles.card, pressed && styles.cardPressed]}
      onPress={() => router.push(`/puzzles/contradiccion/${puzzle.id}` as never)}
    ...
    >
      ...
      <View style={styles.cardFooter}>
        <Text style={styles.cardMeta}>🔍 {puzzle.sentences.length} enunciados</Text>
...
export default function ContradiccionListScreen() {
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.title}>Encontrá la mentira</Text>
        <Text style={styles.subtitle}>
          Leé el relato del sospechoso y detectá las dos frases que se contradicen entre sí.
        </Text>
        <View style={styles.list}>
          {CONTRADICCION_PUZZLES.map((p) => (
