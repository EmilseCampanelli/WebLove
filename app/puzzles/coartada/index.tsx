...
import { COARTADA_PUZZLES } from "../../../src/data/puzzles/coartada/puzzles";
import { CoartadaPuzzle } from "../../../src/data/puzzles/coartada/types";
...
function PuzzleCard({ puzzle }: { puzzle: CoartadaPuzzle }) {
  const diff = DIFF_CONFIG[puzzle.difficulty];
  return (
    <Pressable
      style={({ pressed }) => [styles.card, pressed && styles.cardPressed]}
      onPress={() => router.push(`/puzzles/coartada/${puzzle.id}` as never)}
    ...
    >
      ...
      <View style={styles.cardFooter}>
        <Text style={styles.cardMeta}>
          {puzzle.suspect.emoji} {puzzle.suspect.name}
        </Text>
...
export default function CoartadaListScreen() {
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.title}>Rompé la coartada</Text>
        <Text style={styles.subtitle}>
          Cruzá testimonios con evidencias físicas para descubrir qué par delata al sospechoso.
        </Text>
        <View style={styles.list}>
          {COARTADA_PUZZLES.map((p) => (
