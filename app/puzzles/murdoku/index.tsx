...
import { MURDOKU_PUZZLES } from "../../../src/data/puzzles/murdoku/puzzles";
import { Colors, Radius } from "../../../src/theme";
import { MurdokuPuzzle } from "../../../src/data/puzzles/murdoku/types";
...
function PuzzleCard({ puzzle }: { puzzle: MurdokuPuzzle }) {
  const diff = DIFF_CONFIG[puzzle.difficulty];
  return (
    <Pressable
      style={({ pressed }) => [styles.card, pressed && styles.cardPressed]}
      onPress={() => router.push(`/puzzles/murdoku/${puzzle.id}` as never)}
    ...
    >
      ...
      <View style={styles.cardFooter}>
        <Text style={styles.suspectCount}>🕵️ {puzzle.suspects.length} sospechosos</Text>
...
export default function MurdokuListScreen() {
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <Text style={styles.eyebrow}>MURDOKU</Text>
        <Text style={styles.title}>Casos de asesinato</Text>
        <Text style={styles.subtitle}>
          Ubicá a cada sospechoso en su habitación. Quien comparte la habitación con la víctima es el asesino.
        </Text>
        <View style={styles.list}>
          {MURDOKU_PUZZLES.map((p) => (
