...
import { MAPA_PUZZLES } from "../../../src/data/puzzles/mapa/puzzles";
import { MapaPuzzle } from "../../../src/data/puzzles/mapa/types";
...
function PuzzleCard({ puzzle }: { puzzle: MapaPuzzle }) {
  const diff = DIFF_CONFIG[puzzle.difficulty];
  return (
    <Pressable
      style={({ pressed }) => [styles.card, pressed && styles.cardPressed]}
      onPress={() => router.push(`/puzzles/mapa/${puzzle.id}` as never)}
    ...
    >
      ...
      <View style={styles.cardFooter}>
        <Text style={styles.cardMeta}>
          🧭 {puzzle.suspect.emoji} {puzzle.suspect.name} · {puzzle.gridCols}×{puzzle.gridRows}
        </Text>
  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.title}>Trazá la ruta</Text>
        <Text style={styles.subtitle}>
          Seguí la declaración del sospechoso y trazá su ruta en el plano. Si pasa por la escena del crimen, mintió.
        </Text>
